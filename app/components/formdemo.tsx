...
export function SignupFormDemo () {
  ...
  return (
    <div id="formid" className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-2 md:p-8 shadow-input bg-white dark:bg-black">
    ...
    Acercanos tus datos y se pondran en contacto con vos.
      ...
      <form  className="my-10" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input id="email" placeholder="usuario@hotmail.com" type="email" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
          <Label htmlFor="telefono">Telefono</Label>
          <Input id="telefono" placeholder="Telefono" type="telefono" />
        </LabelInputContainer>
     
        <LabelInputContainer className="mb-8">
          <Label htmlFor="telefono">Consulta</Label>
          <Input id="Mensaje" placeholder="Consulta" type="Mensaje" />
        </LabelInputContainer>
